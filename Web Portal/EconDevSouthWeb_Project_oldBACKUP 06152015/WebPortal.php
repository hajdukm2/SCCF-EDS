...
<html>
	<head>
		...
		<link href="http://EDSAppLB-1862368837.us-west-2.elb.amazonaws.com/CSS/HomePage.css" rel="stylesheet">
		...
		<script>
			$(document).ready(function(){
				...
				$("#newuser").click(function(){
					location.href ="http://EDSAppLB-1862368837.us-west-2.elb.amazonaws.com/NewUserForm.php";
				});
	...
	<br><br><br>
		<div class="container" id="loginscreen">
   			<img src="http://EDSAppLB-1862368837.us-west-2.elb.amazonaws.com/Images/newLogo.png" alt="EDS Logo" width="600" class="ri"><br><br>
  			<form role="form" action="http://EDSAppLB-1862368837.us-west-2.elb.amazonaws.com/Login.php" Method="Post">
