...
<html>
	...
	<body style="background-color:#DeeBB3;">
		<div class="container-fluid text-center" style="background-color:#8B4E9E;padding-bottom:25px;">
 			<a href="http://eds-qa-lb-495482778.us-west-2.elb.amazonaws.com/WebPortal.php"><img src="./Images/SMR.png" class="img-rounded" style="width:30%;margin-top:12px;margin-bottom:22px;box-shadow: 0 3px 6px rgba(0,0,0,0.9);"></a><br>
 		...
 		<div class="container-fluid" style="background-color:#8BAD7A;padding-top:25px;">
 			<form role="form" action="http://eds-qa-lb-495482778.us-west-2.elb.amazonaws.com/NewUser.php" method="POST">
 			...
 			<div class="text-center" style="width:100%;">
 				<a href="http://eds-qa-lb-495482778.us-west-2.elb.amazonaws.com/WebPortal.php"><button type="button" class="btn btn-warning btn-lg">Return to Login Page</button></a>
 			</div>
 		</div>
	</body>
</html>